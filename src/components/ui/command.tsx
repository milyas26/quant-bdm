...
function CommandDialog({
  ...
  return (
    <Dialog {...dialogProps}>
      ...
      <DialogContent
        className={cn(
          "top-1/3 translate-y-0 overflow-hidden rounded-sm! p-0 sm:max-w-2xl",
          className
        )}
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-8! rounded-sm! border-input/30 bg-input/30 -none! *:data-[slot=input-group-addon]:pl-2!">
