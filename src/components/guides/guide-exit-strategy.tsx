    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <Card className="border-warning/30">
          <CardHeader className="border-b">
            <div className="flex items-center gap-2">
              <div className="h-2.5 w-2.5 rounded-full bg-amber-400/20 text-amber-400" />
              <CardTitle className="text-base text-warning">Distribution Signal</CardTitle>
            </div>
          ...
          <CardContent className="pt-4 space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-400/20 text-amber-400" />
            ...
            <div className="rounded-sm border border-warning/20 bg-amber-400/5 p-2 text-xs text-warning">
        ...
        <Card className="border-destructive/30">
          <CardHeader className="border-b">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base text-negative ">Trend Failure</CardTitle>
            </div>
          ...
          <CardContent className="pt-4 space-y-4">
            ...
            <div className="rounded-sm border bg-muted/30 p-3 text-center">
              ...
              <div className="text-2xl font-black text-negative mt-1">5–8%</div>
        ...
        <CardContent className="pt-4">
          <div className="space-y-3">
            {[
              ...
              { condition: "Broker mulai net sell setelah sebelumnya accumulation", action: "Exit sebagian atau full posisi", color: "text-warning", border: "border-warning/30", bg: "bg-amber-400/5" },
              { condition: "Volume spike tapi harga tidak bergerak naik", action: "Waspada — siapkan exit", color: "text-yellow-500", border: "border-yellow-500/30", bg: "bg-amber-400/5" },
              { condition: "Harga turun di bawah breakout level", action: "Exit segera — false breakout", color: "text-negative", border: "border-destructive/30", bg: "bg-destructive/5" },
              { condition: "Loss mencapai 5–8% dari entry", action: "Cut loss — lindungi modal", color: "text-negative", border: "border-destructive/30", bg: "bg-destructive/5" },
            ].map(({ condition, action, color, border, bg }) => (
              <div key={condition} className={`flex flex-col sm:flex-row sm:items-center justify-between rounded-sm border ${border} ${bg} gap-2 p-3`}>
      ...
      <div className="flex items-start gap-3 rounded-sm border bg-indigo-500/5 p-4 text-sm">
