  ...
  return (
    ...
    >
      <div className="flex min-w-0 flex-1 items-center gap-1.5">
        ...
        {isEditing ? (
          <Input
            className="h-6 flex-1 rounded-sm px-1 font-mono text-xs"
            value={editName}
      ...
      <div className="flex items-center gap-1">
        <Badge
          variant="secondary"
          className="h-4 rounded-sm px-1 font-mono text-[9px]"
        >
      ...
      <div className="flex w-56 shrink-0 flex-col border-r border-border">
        <div className="flex items-center justify-between border-b border-border px-3 py-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-xs font-semibold">Watchlists</span>
          </div>
          <Button
            variant="ghost"
            size="icon"
          ...
          <>
            <div className="flex items-center justify-between border-b border-border px-4 py-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="h-7 rounded-sm font-mono text-xs text-destructive hover:text-destructive"
                onClick={() =>
                  setDeleteWatchlistTarget({
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              {ticker.logo ? (
                                ...
                                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-muted font-mono text-[10px]">
                                  {ticker.symbol?.[0]}
                                </div>
                              )}
                              <div>
                                <span className="flex items-center gap-1 font-mono text-[12px] font-bold">
                                  {ticker.symbol}
                                  {s?.isBreakout && (
                                    <Badge
                                      variant="outline"
                                      className="text-positive bg-positive h-4 rounded-sm border-emerald-400/20 px-1 font-mono text-[9px]"
                                    >
                                      BO
                                    </Badge>
                                  )}
                          ...
                          <TableCell>
                            {s ? (
                              <div>
                                ...
                                {s.isVolumeSpike && (
                                  <span className="text-warning bg-warning ml-1 rounded-sm px-1 py-px font-mono text-[9px]">
                                    Spike
                                  </span>
                                )}
                              </div>
                          ...
                          <TableCell>
                            {s ? (
                              <span
                                className={cn(
                                  "font-mono text-[10px]",
                                  s.momentum === "Uptrend" && "text-positive",
                                  s.momentum === "Downtrend" && "text-negative"
                                )}
                              >
                                {s.momentum}
                              </span>
                            ...
                            {s ? (
                              <div className="flex max-w-32 flex-wrap gap-1">
                                {s.brokersBuy?.map((b: any, idx: number) => (
                                  <span
                                    key={b.netbsBrokerCode + "-" + idx}
                                    className={cn(
                                      "rounded-sm bg-muted/50 px-1 py-0.5 font-mono text-[9px]",
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              "{deleteWatchlistTarget?.name}" will be permanently deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <strong>{deleteTickerTarget?.symbol}</strong> will be removed from
              this watchlist.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
